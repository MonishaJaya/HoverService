...
public class HooverController {
	 ...
	 @Autowired
	    ...
	    @Operation(summary = "Service that navigates an imaginary robotic hoover",
	            description = "Final coordinates of the hoover and patches is the number of cleaned patches.",
	            extensions = {
	                    @Extension(properties = {
	                            @ExtensionProperty(name = "x-lifecycleStatus", value = "ACTIVE"),
	                            @ExtensionProperty(name = "x-retirementDate", value = "")
	                    })
	            },
	            responses = {
